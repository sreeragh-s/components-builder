...
export default function RightSideBar({ formData, updateFormData }: {formData: any, updateFormData: any}) {
  ...
  return (
    <aside
      id="RightSideBar"
      className="fixed bg-background  z-10 h-full top-0 right-0 flex lg:flex flex-shrink-0 flex-col w-80 "
    >
      <div className="relative flex-1 flex flex-col min-h-0 border-l dark:border-neutral-700  pt-0">
